...
(Если нет времени для чтения всей статьи, пролистайте до [мтнч](#мтнч))
...
Что же тогда делать? Я для себя нашёл ответ - использовать [yalc](https://github.com/wclr/yalc), созданный [@whitecolor](https://medium.com/@_whitecolor).
